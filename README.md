...
| Pipeline Parallelism | ✅ Validated on CPU |
| Context Parallelism | ✅ Validated on CPU|
| Training and validating NanoGPT on GPUs with (DP+TP+PP) | 🔄 In progress |
...
## Roadmap
Context Parallelism → Sequence Parallelism → Expert Parallelism → FSDP
